...
CREATE TABLE IF NOT EXISTS "permissionsToRoles" (
	...
	CONSTRAINT "permissionsToRoles_role_id_user_id_pk" PRIMARY KEY("role_id","user_id")
);
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "permissionsToRoles" ADD CONSTRAINT "permissionsToRoles_user_id_permissions_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."permissions"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
